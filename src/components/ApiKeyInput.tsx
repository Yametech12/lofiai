...
export default function ApiKeyInput({ onApiKeyChange, serverKeyConfigured }: ApiKeyInputProps) {
  ...
  const icons = {
    ...
    'eye': (
     ...
     'eye-off': (
       <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
         <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a10.058 10.058 0 013.083-3.083M9.88 9.88a3 3 0 104.24 4.24M9.88 9.88l-2.12 2.12M12 5v14M12 5l-4 4M12 5l4 4" />
       </svg>
     ),
  };
